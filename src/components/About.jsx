  ...
  return (
    ...
    >
      ...
      <div className="max-w-6xl mx-auto flex flex-col lg:flex-row gap-12 lg:gap-16 items-center relative z-10">
        ...
        <div className="w-full lg:w-7/12 flex flex-col space-y-6 sm:space-y-8 mt-6 lg:mt-0">
          {/* Header */}
          <h2 className="text-3xl md:text-5xl font-mono font-bold text-slate-100 tracking-tight">
            <span className="text-cyan-400 mr-2 sm:mr-4 font-normal">&gt;</span>
            About Me
          </h2>

          {/* Bio Text */}
          <p className="text-slate-400 text-sm sm:text-base md:text-lg leading-relaxed font-sans w-full">
          ...
          >
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4 pt-2">
              ...
              {/* Stat 1: Coding */}
              <div className="group bg-[#11161d] border border-zinc-400/20 rounded-xl p-4 sm:p-6 flex flex-col items-center justify-center text-center hover:border-cyan-500/60 transition-all duration-300">
                <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-full bg-slate-800/40 group-hover:bg-cyan-500/10 flex items-center justify-center mb-3 sm:mb-4 text-slate-400 group-hover:text-cyan-400 transition-colors duration-300">
                  <Code2 className="w-4 h-4 sm:w-5 sm:h-5 stroke-[1.5]" />
                </div>
                <h3 className="text-xl sm:text-2xl font-bold text-white mb-0.5 sm:mb-1">3+</h3>
                <p className="text-[9px] sm:text-[10px] tracking-[0.15em] sm:tracking-[0.2em] font-mono text-slate-500 group-hover:text-slate-400 transition-colors duration-300 uppercase">
                  Years Coding
                </p>
              </div>
              ...
              <div className="group bg-[#11161d] border border-zinc-400/20 rounded-xl p-4 sm:p-6 flex flex-col items-center justify-center text-center hover:border-cyan-500/60 transition-all duration-300">
                <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-full bg-slate-800/40 group-hover:bg-cyan-500/10 flex items-center justify-center mb-3 sm:mb-4 text-slate-400 group-hover:text-cyan-400 transition-colors duration-300">
                  <FolderGit2 className="w-4 h-4 sm:w-5 sm:h-5 stroke-[1.5]" />
                </div>
              ...
              <div className="group bg-[#11161d] border border-zinc-400/20 rounded-xl p-4 sm:p-6 flex flex-col items-center justify-center text-center hover:border-cyan-500/60 transition-all duration-300">
                <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-full bg-slate-800/40 group-hover:bg-cyan-500/10 flex items-center justify-center mb-3 sm:mb-4 text-slate-400 group-hover:text-cyan-400 transition-colors duration-300">
                  <Cpu className="w-4 h-4 sm:w-5 sm:h-5 stroke-[1.5]" />
                </div>
                <h3 className="text-xl sm:text-2xl font-bold text-white mb-1">15+</h3>
                <p className="text-[9px] sm:text-[10px] tracking-[0.15em] sm:tracking-[0.2em] font-mono text-slate-500 group-hover:text-slate-400 transition-colors duration-300 uppercase">
                  Technologies
              ...
              <div className="group bg-[#11161d] border border-zinc-400/20 rounded-xl p-4 sm:p-6 flex flex-col items-center justify-center text-center hover:border-cyan-500/60 transition-all duration-300">
                ...
                <h3 className="text-xl sm:text-2xl font-bold text-white mb-1">210+</h3>
                <p className="text-[9px] sm:text-[10px] tracking-[0.15em] sm:tracking-[0.2em] font-mono text-slate-500 group-hover:text-slate-400 transition-colors duration-300 uppercase">
                  Github commits
                </p>
              </div>
